...
<?= $this->section('content') ?>
    <div class="wrapper ">
        ...
        <div class="main-panel">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card card-stats">
                            <div class="card-body">
                                <h3><i class="fa fa-list-alt" aria-hidden="true"></i> Data Semua List Waktu Pengerjaan</h3>
					            <input type="hidden" id="hidden-csrf" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />

                                <div id="list-waktu"></div>
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/babel" id="scripts-list-data" src="<?= base_url() ?>/assets/reactjs/list-waktu-pengerjaan.js?endpoint=<?= base_url(); ?>&status_user=<?= $_SESSION['status']; ?>&nipdata=<?= $_SESSION['nip']; ?>"></script>
