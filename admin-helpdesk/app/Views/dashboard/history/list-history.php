...
<?= $this->section('content') ?>
    <div class="wrapper ">
        ...
        <div class="main-panel">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card card-stats">
                            <div class="card-body">
                                <h3><i class="fa fa-list-alt" aria-hidden="true"></i> Data Semua History Pekerjaan</h3>
            ...
            <script type="text/babel" id="scripts-list-data" src="<?= base_url() ?>/assets/reactjs/list-history.js?endpoint=<?= base_url(); ?>&status_user=<?= $_SESSION['status']; ?>&nipdata=<?= $_SESSION['nip']; ?>"></script>
